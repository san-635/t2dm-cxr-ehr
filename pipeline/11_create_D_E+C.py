...
# return a generator that reads 'D_E+C_partitions.csv' in subsets of size 'subset_size'
...
def process_subset(args, subset, writer_train, writer_val, writer_test, eps=1e-6):
    for episode in subset:
        ...
        with open(os.path.join(episode_path, ts_files[0])) as ts_file:
            # 1/6: get length of stay (los) in hours from 'episode{#}.csv'
            ...
            # 2/6: keep only those rows of 'episode{#}_timeseries.csv' that were recorded within the los
            ...
            # 3/6: save the episode's time series EHR features as '{subject_id}_{stay_id}_timeseries.csv' in appropriate partition sub-dir. of 'D_E+C' dir.
            ...
            # 4/6: get label for this episode
            t2dm_label = 0
            ...
            # 5/6: get the episode's stay_id and non-time series EHR features
            ...
            # 6/6: copy the episode's CXR image to episode-specific sub-dir. in 'CXR_images' dir. of 'D_E+C' dir.
            ...
            # write the episode's label, non-time series EHR features, and CXR image's path to the 'listfile.csv' in appropriate partition sub-dir. of 'D_E+C' dir.
            listfile_row = (output_ts_file, stay_id, t2dm_label, gender, age, family_history, output_cxr_path)
...
def main():
    ...
    listfile_header = "timeseries,stay_id,label,gender,age,family_history,cxr_path"
