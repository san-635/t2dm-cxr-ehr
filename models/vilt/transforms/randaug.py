...
# gaussian blur
def Blur(img, _):
    return img.filter(PIL.ImageFilter.GaussianBlur(radius=5))
...
def augment_list_v2():  # 16 operations and their ranges
    # https://github.com/tensorflow/tpu/blob/8462d083dd89489a79e3200bcc8d4063bf362186/models/official/efficientnet/autoaugment.py#L505
    l = [
        (AutoContrast, 0, 1),
        (Equalize, 0, 1),
...
class RandAugment2:
    def __init__(self, n, m):
        self.n = n
        self.m = m  # [0, 30]
        self.augment_list = augment_list_v2()
